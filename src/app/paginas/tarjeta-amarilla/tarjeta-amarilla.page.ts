...
@Component({
  selector: 'app-tarjeta-amarilla',
  templateUrl: './tarjeta-amarilla.page.html',
  styleUrls: ['./tarjeta-amarilla.page.scss'],
})
export class TarjetaAmarillaPage implements OnInit {
  minutos:string
  segundos:string
  ...
  async obtenerdatos(datos){
    ...
    console.log(this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][this.numerocat])
    this.nombrecategoria=this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][0]["categoria"]
    this.nombrepreg=this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][0]["preguntas"][this.numeropreg]["preg"]
    this.nombrepista=this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][0]["preguntas"][this.numeropreg]["pista"]
    this.nombrerespuesta=this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][0]["preguntas"][this.numeropreg]["respuesta"]
    this.nombreropcion=this.archivojson["tarjeta_amarilla"]["preguntas_tarjeta"][0]["preguntas"][this.numeropreg]["opcion"]
  }
  getRandomArbitrary2() {
  ...
  stopTimer(){
    ...
    if(this.nombreingreso.toUpperCase()==this.nombrerespuesta){
